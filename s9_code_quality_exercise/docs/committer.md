...
**ALWAYS** Re-read these instructions after every commit that you do:  ~/.claude/commands/role-committer.md.  When you re-read this file, say `♻️ Committer rules re-read`
...
- If you need any input from me, talk to me ouloud by running command `speak <YOUR MESSAGE>`
